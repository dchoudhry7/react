      ...
      <div className="flex items-center justify-center min-h-screen">
        <div className="bg-neutral-primary-soft block max-w-sm border border-default rounded-base shadow-xs">
          ...
          <div className="p-6 text-center">
            ...
            <a
              href="#"
              className="inline-flex items-center text-black bg-brand box-border border border-black rounded-xl hover:bg-brand-strong focus:ring-4 focus:ring-brand-medium shadow-xs font-medium leading-5 rounded-base text-sm px-4 py-2.5 focus:outline-none"
            >
              Read more
              <svg
